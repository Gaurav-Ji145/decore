...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'F:\Gaurav\Gaurav PC\Gaurav NSTI  WORK\Core module 4\PythonTeamproject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'F:\Gaurav\Gaurav PC\Gaurav NSTI  WORK\Core module 4\PythonTeamproject\venv\Scripts\deactivate.nu'
